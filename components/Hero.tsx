...
const Hero = () => {
  return (
    <div className="h-[400px] w-full  max-lg:h-[900px] max-md:h-[550px]">
      <div className="grid grid-cols-3 items-center justify-items-end px-10 gap-x-10 max-w-screen-2xl mx-auto h-full max-lg:grid-cols-1 max-lg:py-10 max-lg:gap-y-10">
        <div className="flex flex-col gap-y-5 max-lg:order-last col-span-2">
          <h1 className="text-6xl  font-bold mb-3 max-xl:text-5xl max-md:text-4xl max-sm:text-3xl">
          ...
          <div className="flex gap-x-1 max-lg:flex-col max-lg:gap-y-1">
            <button className="bg-gray-50 rounded-xl border-[1px] text-blue-600 font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-gray-100">
              BUY NOW
            </button>
            <button className="bg-gray-50 rounded-xl border-[1px] text-blue-600 font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-gray-100">
              LEARN MORE
