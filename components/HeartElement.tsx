  ...
  return (
    <div className="relative">
      <Link href="/wishlist">
        ...
        <span className="block w-6 h-6 font-bold border-[1px] rounded-full flex justify-center items-center absolute top-[-17px] right-[-22px] transition-all duration-300 transform hover:scale-110">
          {wishQuantity}
        </span>
      </Link>
    </div>
